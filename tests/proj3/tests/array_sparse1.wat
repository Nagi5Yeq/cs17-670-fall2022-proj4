(module
  ...
  (func $alloc (param i32) (result externref)
    ...
    (loop $l
      (local.set $key (call $b (i32.mul (local.get 0) (i32.const 4763899))))
      (call $s (local.get $obj) (local.get $key) (local.get $key))
  ...
  (func (export "main") (param i32) (result i32)
    (call $get (call $alloc (local.get 0)) (i32.const 4763899))
  )
)
